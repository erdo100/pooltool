...
class plot_3cushion():
    ...
    def create_sliders(self, slider_frame, params, total_shots, update_shot_id, update_plot):
        ...
        sliders['physics_ballball_a'] = ballball_a_slider = Scale(slider_frame, from_=0, to=0.1, resolution=0.01, orient=HORIZONTAL, label="Ball-Ball a", length=slider_length, command=update_plot)
    ...
    def start_read_shotfile(self):
        self.shots_actual = open_shotfile()
    ...
    def update_plot(self, event=None):
        ...
        for i, rvw in enumerate([white_rvw, yellow_rvw, red_rvw]):
            ...
            # Actual Shot
            ta = shot_actual["balls"][i+1]["t"]
            xa = shot_actual["balls"][i+1]["x"]
            ya = shot_actual["balls"][i+1]["y"]
