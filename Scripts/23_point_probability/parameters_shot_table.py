class Parameters:
    def __init__(self):
        ...
        self.value = {
            ...
            # Physics parameters
            'physics_u_slide': 0.192,
            'physics_u_roll': 0.004,
            'physics_u_sp_prop': 0.2,
            'physics_e_ballball': 0.975,
            'physics_e_cushion': 0.857,
            'physics_f_cushion': 0.2,
