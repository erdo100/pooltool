...
# function to set lower and upper limit based on shot_param, shot_param_tol and shot_param_limits
...
for i, shot_actual in enumerate(shots_actual):
    ...
    output_dir = r"E:\PYTHON_PROJECTS\pooltool\3cushiontool\Scripts\10_piecewise_optimizer"
